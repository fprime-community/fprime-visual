...
def parse_args():
    ...
    parser.add_argument("--source-dir", nargs="*", help="Specify source directories (JSON files). If not provided, uses current directory.", required=False, default=[os.getcwd()])
